...
public class PassengerDAO extends BaseDAO<Passenger>{
	...
	{
		return saveWithPK("INSERT INTO passenger (id, booking_id, given_name, family_name, dob, gender, address) VALUES (?, ?, ?, ?, ?, ?, ?)",
				new Object[] {passenger.getPassId(), passenger.getBookingID().getId(), passenger.getfName(),
