...
public class BookingDAO extends BaseDAO<Booking>{
	...
	{
		return saveWithPK("INSERT INTO booking (is_active, confermation_code) VALUES (?, ?)",
	...
	{
		save("UPDATE booking set is_active =? , confermation_code= ? where id = ?", 
	...
	public List<Booking> extractData(ResultSet rs) throws ClassNotFoundException, SQLException
	{
		...
		while(rs.next())
		{
			...
			booking.setConfermationCode(rs.getString("comfermatopm_code"));
